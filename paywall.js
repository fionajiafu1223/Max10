...
(function() {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .pw-plan.selected { border: 2px solid #4a9fd4 !important; background: #e8f4fd !important; }
      .pw-plan.highlight { background: #ffffff; }
      .pw-plan.highlight.selected { border: 2px solid #4a9fd4 !important; background: #e8f4fd !important; }
